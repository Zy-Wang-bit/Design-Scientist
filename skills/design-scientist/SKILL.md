...
framework/operator_gap_matrix.csv
framework/operator_evidence_map.json
...
runs/<run_id>/novelty_review.json
runs/<run_id>/baseline_audit.json
runs/<run_id>/experiment_review.json
runs/<run_id>/biology_review.json
runs/<run_id>/paper_contribution_review.json
runs/<run_id>/nodes/<node_id>/mechanism_spec.json
runs/<run_id>/nodes/<node_id>/mechanism.py
runs/<run_id>/nodes/<node_id>/proposal.json
runs/<run_id>/nodes/<node_id>/ablation_plan.json
runs/<run_id>/nodes/<node_id>/stress_test_plan.json
runs/<run_id>/nodes/<node_id>/mechanism_metrics.json
runs/<run_id>/nodes/<node_id>/validation_report.json
runs/<run_id>/nodes/<node_id>/operator_to_code_trace.json
